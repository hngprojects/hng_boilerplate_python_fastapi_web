...
org_1 = Organization(
    id=uuid7(), name="Python Org", description="An organization for Python developers"
)
org_2 = Organization(
    id=uuid7(),
    name="JavaScript Org",
    description="An organization for JavaScript developers",
)
org_3 = Organization(
    id=uuid7(), name="GoLang Org", description="An organization for GoLang developers"
)
...
# Add sample products
product_1 = Product(
    id=uuid7(), name="Product 1", description="Description for product 1", price=19.99
)

product_2 = Product(
    id=uuid7(), name="Product 2", description="Description for product 2", price=29.99
)

product_3 = Product(
    id=uuid7(), name="Product 3", description="Description for product 3", price=39.99
)
