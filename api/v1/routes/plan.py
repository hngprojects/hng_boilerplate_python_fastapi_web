...
@plan_router.get('/organizations/{organization}/billing-plans/{plan_name}', status_code=status.HTTP_200_OK, response_model=SubscriptionPlanResponse)
async def get_billing_plan_details(
    ...
    billing_plan = plan_service.get_billing_plan_details(db, organization, plan_name)
