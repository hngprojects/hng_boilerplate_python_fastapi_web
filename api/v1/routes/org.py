...
@org.post("/{org_id}/add-user", status_code=status.HTTP_200_OK)
async def add_user_to_organization(request: Request, org_id: int, db: Session = Depends(get_db), user: User = Depends(get_current_user)):
