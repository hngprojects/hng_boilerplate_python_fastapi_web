...
def test_update_product_with_valid_token(mock_db, mocker):
    ...
    response = client.put("api/v1/product/e65c9f26-696a-42df-a4b9-4da214267", json=product_update, headers={"Authorization": "Bearer valid_token"})
    print(response.json()) 
...
def test_update_product_without_token(mock_db, mocker):
    response = client.put("api/v1/product/e65c9f26-696a-42df-a4b9-4da214267", json={"name": "Product"})
...
def test_update_product_with_invalid_token(mock_db, mocker):
    ...
    response = client.put("api/v1/product/e65c9f26-696a-42df-a4b9-4da21426734c", json={"name": "Product"}, headers={"Authorization": "Bearer invalid_token"})
    assert response.status_code == 401

def test_update_product_with_missing_fields(mock_db, mocker):
    response = client.put("api/v1/product/e65c9f26-696a-42df-a4b9-4da21426734c", json={})
...
def test_update_product_with_nonexistent_id(mock_db, mocker):
    ...
    response = client.put("api/v1/product/e65c9f26-696a-42df-a4b9-4da21426734c", json={"name": "Product", "price": 10.0, "description": "Description"}, headers={"Authorization": "Bearer valid_token"})
...
def test_update_product_with_special_characters(mock_db, mocker):
    ...
    response = client.put("api/v1/product/e65c9f26-696a-42df-a4b9-4da21426734c", json=product_update, headers={"Authorization": "Bearer valid_token"})
    print(response.json()) 
    assert response.status_code == 200
