...
def test_update_privacy_policy_success(client, db_session_mock):
    ...
    db_session_mock.refresh.return_value = mock_privacy_policy
    ...
    with patch("api.v1.services.privacy_policies.privacy_service.update", return_value=mock_privacy_policy) as mock_update:
        ...
        mock_update.assert_called_once_with(db_session_mock, mock_privacy_policy.id, update_data)
